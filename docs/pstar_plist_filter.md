# [`pstar`](/docs/pstar.md).[`plist`](/docs/pstar_plist.md).`filter(self, func=<type 'bool'>, *args, **kwargs)`

Filter `self` by an arbitrary function on elements of `self`, forwarding arguments.

`filter` always returns the root of the filtered [`plist`](/docs/pstar_plist.md).
...
>    [`plist`](/docs/pstar_plist.md) resulting from filtering out elements of `self` for whom `func` evaluated to a `False` value.
